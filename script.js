      ...
      en: {
        ...
        text: {
          ...
          "#referenzen .project:nth-child(3) .project-meta span":
            "Native time tracking and flex balance for the Apple ecosystem.",
          ...
          "#bewertungen .testimonial:nth-child(1) p":
            "\"Great app, I have been using it for a long time and everything works brilliantly.\"",
          "#bewertungen .testimonial:nth-child(1) .who strong": "BeeFocus",
          "#bewertungen .testimonial:nth-child(1) .who .muted": "Schmenren",
          "#bewertungen .testimonial:nth-child(2) p":
            "\"Great app for organizing task lists.\"",
          "#bewertungen .testimonial:nth-child(2) .who strong": "BeeFocus",
          "#bewertungen .testimonial:nth-child(2) .who .muted": "Lehrer Kutzius",
          "#bewertungen .testimonial:nth-child(3) p":
            "\"No gimmicks and no ads. Great app!\"",
          "#bewertungen .testimonial:nth-child(3) .who strong": "BeeFocus",
          "#bewertungen .testimonial:nth-child(3) .who .muted": "Kareem Baker",
          "#faq h2": "FAQ",
    ...
    "beefocus-index": {
      en: {
        ...
        text: {
          ...
          "#product-gallery .lead": "A calm pass through the app's key iPhone and iPad views.",
          ...
          "#features .feature-device:nth-child(1) .feature-shot:nth-child(1) strong": "Daily planner",
          "#features .feature-device:nth-child(1) .feature-shot:nth-child(1) span": "Today, tasks and focus times stay in one clear daily view.",
          "#features .feature-device:nth-child(1) .feature-shot:nth-child(2) strong": "Tasks",
          "#features .feature-device:nth-child(1) .feature-shot:nth-child(2) span": "Open tasks, priorities and lists are easy to scan.",
          "#features .feature-device:nth-child(1) .feature-shot:nth-child(3) strong": "New task",
          "#features .feature-device:nth-child(1) .feature-shot:nth-child(3) span": "Title, category and priority are immediately available.",
          "#features .feature-device:nth-child(1) .feature-shot:nth-child(4) strong": "Timer",
          "#features .feature-device:nth-child(1) .feature-shot:nth-child(4) span": "A session starts directly from the central focus view.",
          "#features .feature-device:nth-child(1) .feature-shot:nth-child(5) strong": "Focus mode",
          "#features .feature-device:nth-child(1) .feature-shot:nth-child(5) span": "During a session, it stays clear what you are focused on.",
          "#features .feature-device:nth-child(1) .feature-shot:nth-child(6) strong": "Statistics",
          "#features .feature-device:nth-child(1) .feature-shot:nth-child(6) span": "Activity and focus time remain visible on mobile.",
          "#features .feature-device:nth-child(1) .feature-shot:nth-child(7) strong": "Focus store",
          "#features .feature-device:nth-child(1) .feature-shot:nth-child(7) span": "Focus extensions and app content are bundled in one place.",
          "#features .feature-device:nth-child(1) .feature-shot:nth-child(8) strong": "BeeFocus Pro",
          "#features .feature-device:nth-child(1) .feature-shot:nth-child(8) span": "Pro features and subscription options are presented transparently.",
          "#features .feature-device:nth-child(1) .feature-shot:nth-child(9) strong": "Settings",
          "#features .feature-device:nth-child(1) .feature-shot:nth-child(9) span": "Dark mode, language and categories sit in one clear view.",
          ...
          "#features .feature-device:nth-child(2) .feature-device-head .muted":
            "The iPad views show the same workflows with more room to plan.",
          "#features .feature-device:nth-child(2) .feature-shot:nth-child(1) strong": "Daily planner",
          "#features .feature-device:nth-child(2) .feature-shot:nth-child(1) span": "The daily overview uses the larger canvas for tasks, focus and planning.",
          "#features .feature-device:nth-child(2) .feature-shot:nth-child(2) strong": "Tasks",
          "#features .feature-device:nth-child(2) .feature-shot:nth-child(2) span": "Lists, priorities and status are especially easy to scan on iPad.",
          "#features .feature-device:nth-child(2) .feature-shot:nth-child(3) strong": "New task",
          "#features .feature-device:nth-child(2) .feature-shot:nth-child(3) span": "The input flow stays spacious, even when more details are added.",
          "#features .feature-device:nth-child(2) .feature-shot:nth-child(4) strong": "Timer",
          "#features .feature-device:nth-child(2) .feature-shot:nth-child(4) span": "Focus time, break and progress remain readable at a glance.",
          "#features .feature-device:nth-child(2) .feature-shot:nth-child(5) strong": "Focus mode",
          "#features .feature-device:nth-child(2) .feature-shot:nth-child(5) span": "The current focus stays prominent without hiding the rest of the day.",
          "#features .feature-device:nth-child(2) .feature-shot:nth-child(6) strong": "Habit tracker",
          "#features .feature-device:nth-child(2) .feature-shot:nth-child(6) span": "Habits and progress can be compared quickly.",
          "#features .feature-device:nth-child(2) .feature-shot:nth-child(7) strong": "Statistics",
          "#features .feature-device:nth-child(2) .feature-shot:nth-child(7) span": "Weekly, monthly and total values get more breathing room on iPad.",
          "#features .feature-device:nth-child(2) .feature-shot:nth-child(8) strong": "Focus store",
          "#features .feature-device:nth-child(2) .feature-shot:nth-child(8) span": "Extensions and content are clearly structured on tablet, too.",
          "#features .feature-device:nth-child(2) .feature-shot:nth-child(9) strong": "BeeFocus Pro",
          "#features .feature-device:nth-child(2) .feature-shot:nth-child(9) span": "Pro features and subscription details stay transparent and tidy.",
          "#features .feature-device:nth-child(2) .feature-shot:nth-child(10) strong": "Settings",
  ...
  const chromeText = {
    ...
    "beefocus-index": {
      en: {
        ...
        ".product-canvas-tablet": { "aria-label": "Automatic BeeFocus iPad product image slideshow" },
      },
    },
    "beefocus-privacy": {
      en: {
  ...
  (() => {
    ...
    const SEARCH_INDEX = [
      ...
      },
      {
        ...
        desc: {
          de: "Ausgewählte Projekte: BeeFocus, Cmdfind und BeeWork.",
          en: "Selected projects: BeeFocus, Cmdfind and BeeWork.",
        },
      ...
      {
        url: "apps/beework/index.html",
        cat: { de: "App", en: "App" },
        title: { de: "BeeWork", en: "BeeWork" },
        desc: {
          de: "Native Arbeitszeit- und Gleitzeit-App für iPhone, iPad und Apple Watch.",
          en: "Native time tracking and flex-balance app for iPhone, iPad and Apple Watch.",
        },
